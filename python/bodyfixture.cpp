...
static void export_body()
{
	...
	class_<b2Body, boost::noncopyable, b2Body*>("b2Body", no_init)
		...
		.def("GetLinearVelocity", &b2Body::GetLinearVelocity, return_value_policy<copy_const_reference>())
		...
		.add_property("position", make_function(&b2Body::GetPosition, return_value_policy<copy_const_reference>()), b2Body_SetPosition)
		...
		.add_property("linearVelocity", make_function(&b2Body::GetLinearVelocity, return_value_policy<copy_const_reference>()), &b2Body::SetLinearVelocity)
