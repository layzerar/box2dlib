...
static void export_jointdef()
{
	...
	class_<b2MotorJointDef, bases<b2JointDef> >("b2MotorJointDef")
		.def("Initialize", &b2MotorJointDef::Initialize)
		.def_readwrite("linearOffset", &b2MotorJointDef::linearOffset)
		.def_readwrite("angularOffset", &b2MotorJointDef::angularOffset)
		.def_readwrite("maxForce", &b2MotorJointDef::maxForce)
		.def_readwrite("maxTorque", &b2MotorJointDef::maxTorque)
		.def_readwrite("correctionFactor", &b2MotorJointDef::correctionFactor)
	;
}
...
static void export_jointobj()
{
	...
	class_<b2Joint, boost::noncopyable, b2Joint*>("b2Joint", no_init)
		...
		.def("ShiftOrigin", pure_virtual(&b2Joint::ShiftOrigin))
	...
	class_<b2DistanceJoint, bases<b2Joint>, boost::noncopyable>("b2DistanceJoint", no_init)
		...
		.def("ShiftOrigin", &b2DistanceJoint::ShiftOrigin)
	...
	class_<b2FrictionJoint, bases<b2Joint>, boost::noncopyable>("b2FrictionJoint", no_init)
		...
		.def("ShiftOrigin", &b2FrictionJoint::ShiftOrigin)
	...
	class_<b2GearJoint, bases<b2Joint>, boost::noncopyable>("b2GearJoint", no_init)
		...
		.def("ShiftOrigin", &b2GearJoint::ShiftOrigin)
	...
	class_<b2MouseJoint, bases<b2Joint>, boost::noncopyable>("b2MouseJoint", no_init)
		...
		.def("ShiftOrigin", &b2MouseJoint::ShiftOrigin)
	...
	class_<b2PrismaticJoint, bases<b2Joint>, boost::noncopyable>("b2PrismaticJoint", no_init)
		...
		.def("ShiftOrigin", &b2PrismaticJoint::ShiftOrigin)
	...
	class_<b2PulleyJoint, bases<b2Joint>, boost::noncopyable>("b2PulleyJoint", no_init)
		...
		.def("ShiftOrigin", &b2PulleyJoint::ShiftOrigin)
	...
	class_<b2RevoluteJoint, bases<b2Joint>, boost::noncopyable>("b2RevoluteJoint", no_init)
		...
		.def("ShiftOrigin", &b2RevoluteJoint::ShiftOrigin)
	...
	class_<b2RopeJoint, bases<b2Joint>, boost::noncopyable>("b2RopeJoint", no_init)
		...
		.def("ShiftOrigin", &b2RopeJoint::ShiftOrigin)
	...
	class_<b2WeldJoint, bases<b2Joint>, boost::noncopyable>("b2WeldJoint", no_init)
		...
		.def("ShiftOrigin", &b2WeldJoint::ShiftOrigin)
	...
	class_<b2WheelJoint, bases<b2Joint>, boost::noncopyable>("b2WheelJoint", no_init)
		...
		.def("ShiftOrigin", &b2WheelJoint::ShiftOrigin)
	...
	class_<b2MotorJoint, bases<b2Joint>, boost::noncopyable>("b2MotorJoint", no_init)
		.def("SetLinearOffset", &b2MotorJoint::SetLinearOffset)
		.def("GetLinearOffset", &b2MotorJoint::GetLinearOffset, return_value_policy<copy_const_reference>())
		.def("SetAngularOffset", &b2MotorJoint::SetAngularOffset)
		.def("GetAngularOffset", &b2MotorJoint::GetAngularOffset)
		.def("SetMaxForce", &b2MotorJoint::SetMaxForce)
		.def("GetMaxForce", &b2MotorJoint::GetMaxForce)
		.def("SetMaxTorque", &b2MotorJoint::SetMaxTorque)
		.def("GetMaxTorque", &b2MotorJoint::GetMaxTorque)
		.def("SetCorrectionFactor", &b2MotorJoint::SetCorrectionFactor)
		.def("GetCorrectionFactor", &b2MotorJoint::GetCorrectionFactor)
		.def("ShiftOrigin", &b2MotorJoint::ShiftOrigin)
		.add_property("linearOffset", make_function(&b2MotorJoint::GetLinearOffset, return_value_policy<copy_const_reference>()))
		.add_property("angularOffset", &b2MotorJoint::GetAngularOffset)
		.add_property("maxForce", &b2MotorJoint::GetMaxForce)
		.add_property("maxTorque", &b2MotorJoint::GetMaxTorque)
		.add_property("correctionFactor", &b2MotorJoint::GetCorrectionFactor)
	;
}
